...
const HOUSING = {
  ...
  seaPermitsSF: {
    ...
    periodChange: -11, yoyChange: +81,
    release: 'Monthly — Seattle SDCI Issued Permits (city only)',
    sparkline: [13,1,4,2,13,28,13,30,54,31,46,29,16,38,41,94,103,80,134,136,96,116,121,110],
    category: 'Construction',
    local: true,
  },
  seaPermitsMF: {
    ...
    periodChange: +51, yoyChange: +74,
    release: 'Monthly — Seattle SDCI Issued Permits (city only)',
    sparkline: [6,35,154,439,204,51,64,215,54,6,131,32,233,1096,226,782,63,135,161,19,173,106,55,106],
    category: 'Construction',
    local: true,
  },
  seaPermitsDADU: {
    ...
    release: 'Monthly — Seattle SDCI Issued Permits (city only)',
    sparkline: [0,13,1,18,1,5,12,51,31,62,25,41,27,39,21,25,13,22,41,30,29,23,8,15],
    category: 'Construction',
    local: true,
  },
  kingPermits: {
    id: 'kingPermits', name: 'King County Permits', section: 'housing',
    value: 666, unit: ' units', date: '2026-08-31',
    periodChange: -438, yoyChange: +59,
  ...
  piercePermits: {
    ...
    value: 189, unit: ' units', date: '2026-08-31',
    periodChange: -220, yoyChange: -478,
  ...
  snohomishPermits: {
    ...
    value: 135, unit: ' units', date: '2026-08-31',
    periodChange: -54, yoyChange: -141,
