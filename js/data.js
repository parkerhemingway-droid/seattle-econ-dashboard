...
const HOUSING = {
  ...
  seaPermitsSF: {
    ...
    sparkline: [11,1,4,2,13,18,30,30,54,31,46,30,17,38,41,94,103,80,134,136,96,116,121,107],
    category: 'Construction',
    local: true,
  },
  seaPermitsMF: {
  ...
  seaPermitsDADU: {
    ...
    release: 'Monthly — Seattle SDCI Issued Permits (city only)',
    sparkline: [0,13,1,18,1,5,15,52,35,67,27,44,27,41,22,25,13,22,41,30,29,23,8,15],
    category: 'Construction',
    local: true,
  },
  kingPermits: {
